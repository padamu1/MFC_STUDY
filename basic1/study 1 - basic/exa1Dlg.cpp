...
BEGIN_MESSAGE_MAP(Cexa1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTT_PRINT, &Cexa1Dlg::OnBnClickedButtPrint)
	ON_BN_CLICKED(IDC_BUTT_EXIT, &Cexa1Dlg::OnBnClickedButtExit)
END_MESSAGE_MAP()
...
void Cexa1Dlg::OnBnClickedButtPrint()
{
	...
	MessageBox("메시지 상자", "출력");// 첫번째는 메시지 상자 안의 내용, 두번째는 메시지 상자 제목
